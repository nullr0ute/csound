...
OENTRY opcodlst_1[] = {
  ...
  { "cosseg.a", S(COSSEG),0,  5,      "a",    "iim",  csgset, NULL, cosseg  },
  { "cossegb", S(COSSEG),0, 3,      "k",    "iim",  csgset_bkpt, kosseg, NULL  },
  { "cossegb.a", S(COSSEG),0, 5,      "a",    "iim",  csgset_bkpt, NULL, cosseg  },
  { "cossegr", S(COSSEG),0,  3,     "k",    "iim",  csgrset, kcssegr, NULL  },
  { "cossegr.a", S(COSSEG),0,  5,     "a",    "iim",  csgrset, NULL, cossegr  },
  ...
  { "linsegb.a", S(LINSEG),0,  5,     "a",    "iim", lsgset_bkpt, NULL, linseg  },
  { "linsegr",S(LINSEG),0,  3,      "k",    "iim",  lsgrset,klnsegr,NULL },
  { "linsegr.a",S(LINSEG),0,  5,      "a",    "iim",  lsgrset,NULL,linsegr },
  { "expseg", S(EXXPSEG),0,  3,     "k",    "iim",  xsgset, kxpseg, NULL  },
  { "expseg.a", S(EXXPSEG),0,  5,     "a",    "iim",  xsgset, NULL, expseg  },
  { "expsegb", S(EXXPSEG),0,  3,     "k",    "iim",  xsgset_bkpt, kxpseg, NULL },
  { "expsegb.a", S(EXXPSEG),0, 5,     "a",    "iim",  xsgset_bkpt, NULL, expseg },
  { "expsega",S(EXPSEG2),0,  5,     "a",    "iim",  xsgset2, NULL, expseg2  },
  { "expsegba",S(EXPSEG2),0,  5,     "a",    "iim",  xsgset2b, NULL, expseg2 },
  { "expsegr",S(EXPSEG),0,  3,      "k",    "iim",  xsgrset,kxpsegr,NULL },
  { "expsegr.a",S(EXPSEG),0,  5,      "a",    "iim",  xsgrset,NULL,expsegr },
  ...
  */
  ...
  { "soundin",S(DISKIN2),0,5,"mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm","Soooo",
    sndinset_S, NULL, soundin   },
  { "soundin.i",S(DISKIN2),0,5,"mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm","ioooo",
  ...
  { "outs",   S(OUTX),0,     5,      "",     "y",    ochn,   NULL,   outall },
  { "outq",   S(OUTX),0,     5,      "",     "y",    ochn,   NULL,   outall },
  { "outh",   S(OUTX),0,     5,      "",     "y",    ochn,   NULL,   outall },
  { "outo",   S(OUTX),0,     5,      "",     "y",    ochn,   NULL,   outall },
  { "outx",   S(OUTX),0,     5,      "",     "y",    ochn,   NULL,   outall },
  { "out32",  S(OUTX),0,     5,      "",     "y",    ochn,   NULL,   outall },
  { "outs1",  S(OUTM),0,    4,      "",     "a",    NULL,   NULL,   outs1   },
  { "outs2",  S(OUTM),0,    5,      "",     "a",    och2,   NULL,   outs2   },
  { "outq1",  S(OUTM),0,    4,      "",     "a",    NULL,   NULL,   outs1   },
  { "outq2",  S(OUTM),0,    5,      "",     "a",    och2,   NULL,   outs2   },
  { "outq3",  S(OUTM),0,    5,      "",     "a",    och3,   NULL,   outq3   },
  { "outq4",  S(OUTM),0,    5,      "",     "a",    och4,   NULL,   outq4   },
  ...
  { "limit.a",  S(LIMIT),0, 4, "a",     "akk",  NULL,          NULL,  (SUBR)limit },
  ...
  */
  ...
  { "outc",   S(OUTX),0,    4,      "",     "y",    ochn,   NULL,   outall  },
  ...
  { "invalue",   0xFFFF,   _CR,    0,   NULL,   NULL, (SUBR) NULL, (SUBR) NULL },
  ...
  {  "S",   S(STRGET_OP),0,   1,  "S",    "i",
     (SUBR) s_opcode, (SUBR) NULL, (SUBR) NULL                           },
  {  "S",   S(STRGET_OP),0,   3,  "S",    "k",
     (SUBR) s_opcode,(SUBR) s_opcode_k, (SUBR) NULL                       },
  ...
  */
  { "chano",       0xFFFD,  _CW, 0,      NULL, NULL, (SUBR) NULL, (SUBR) NULL },
  ...
  { "chani",      0xFFFF,  _CR,      0,   NULL, NULL, (SUBR) NULL, (SUBR) NULL },
